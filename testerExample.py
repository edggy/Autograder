...
#  Edited by Ethan Gertler, December 2017.
...
# Set of functons that the student is allowed to call
...
class AllTests (unittest.TestCase):
	...
	def test_test1_1 (self): self.assertEqual(test1(0,0), 'The sum of %s plus %s is %s' % (0,0,0))
	def test_test1_2 (self): self.assertEqual(test1(2,0), 'The sum of %s plus %s is %s' % (2,0,2))
	def test_test1_3 (self): self.assertEqual(test1(0,4), 'The sum of %s plus %s is %s' % (0,4,4))
	def test_test1_4 (self): self.assertEqual(test1(10,5), 'The sum of %s plus %s is %s' % (10,5,15))
	def test_test1_5 (self): self.assertEqual(test1(3,11), 'The sum of %s plus %s is %s' % (3,11,14))
	def test_test1_6 (self): self.assertEqual(test1(18,8), 'The sum of %s plus %s is %s' % (18,8,26))
	def test_test1_7 (self): self.assertEqual(test1(100,200), 'The sum of %s plus %s is %s' % (100,200,300))
	def test_test1_8 (self): self.assertEqual(test1(37,11), 'The sum of %s plus %s is %s' % (37,11,48))
	def test_test1_9 (self): self.assertEqual(test1(20,20), 'The sum of %s plus %s is %s' % (20,20,40))
	def test_test1_10 (self): self.assertEqual(test1(2000,481), 'The sum of %s plus %s is %s' %(2000,481,2481))
	
	# test2 tests
	# '#', '*', '_', '@', '!', '|', ':'

	def test_test2_1 (self): self.assertEqual(test2('@', 0), '')
	def test_test2_2 (self): self.assertEqual(test2('#', 1), '#')
	def test_test2_3 (self): self.assertEqual(test2('_', 5), '_____')
	def test_test2_4 (self): self.assertEqual(test2('!', 2), '!!')
	def test_test2_5 (self): self.assertEqual(test2('|', 7), '|||||||')
	def test_test2_6 (self): self.assertEqual(test2('#', 2), '##')
	def test_test2_7 (self): self.assertEqual(test2('|', 6), '||||||')
	def test_test2_8 (self): self.assertEqual(test2('#', 11), '###########')
	def test_test2_9 (self): self.assertEqual(test2('*', 6), '******')
	def test_test2_10(self): self.assertEqual(test2(':', 9), ':::::::::')
	def test_test2_11(self): self.assertEqual(test2('@', 1), '@')
	def test_test2_12(self): self.assertEqual(test2('@', 2), '@@')
	def test_test2_13(self): self.assertEqual(test2('@', 3), '@@@')
	def test_test2_14(self): self.assertEqual(test2('@', 4), '@@@@')
	def test_test2_15(self): self.assertEqual(test2('@', 5), '@@@@@')
	
	# extra credit testBonus tests

	def test_extra_credit_testBonus_1 (self): 
		self.assertEqual(testBonus(1,1,2,2), 1)
	def test_extra_credit_testBonus_2 (self): 
		self.assertEqual(testBonus(1,8,2,8), 0)
	def test_extra_credit_testBonus_3 (self): 
		self.assertEqual(testBonus(0,0,-1,-1), 1)
	def test_extra_credit_testBonus_4 (self): 
		self.assertEqual(testBonus(0,0,-1,1), -1)
	def test_extra_credit_testBonus_5 (self): 
		self.assertEqual(testBonus(9,1,10,9), 8)
		
import random as r
# HardcodeTests suite created by Ethan Gertler
SEED = None
class HardcodeTests(unittest.TestCase):
	...
	def doCase(self, fun, caseGen):
		i, o = caseGen()
		self.assertEqual(fun(*i),o)
	
	def test1_caseGen(self):
		a, b = r.randint(0, 1000), r.randint(0, 1000)
		ans = 'The sum of %s plus %s is %s' % (a, b, a+b)
		return ((a, b), ans)
	
	def test2_caseGen(self):
		a, b = r.choice(['#', '*', '_', '@', '!', '|', ':']), r.randint(0, 1000)
		ans = a * b
		return ((a, b), ans)
	
	def testBonus_caseGen(self):
		# slope
		ax, ay, bx, by = 0, 0, 0, 0
		while bx - ax != 0:
			ax, ay, bx, by = r.randint(-1000, 1000), r.randint(-1000, 1000), r.randint(-1000, 1000), r.randint(-1000, 1000)
		return (by - ay)/(bx - ax)
	
	def test_test1_1(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_2(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_3(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_4(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_5(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_6(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_7(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_8(self): self.doCase(test1, self.test1_caseGen)
	def test_test1_9(self): self.doCase(test1, self.test1_caseGen)
	
	def test_test2_1(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_2(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_3(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_4(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_5(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_6(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_7(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_8(self): self.doCase(test2, self.test2_caseGen)
	def test_test2_9(self): self.doCase(test2, self.test2_caseGen)
	
	def test_extra_credit_testBonus_1(self): 
		self.doCase(testBonus, self.testBonus_caseGen)
	def test_extra_credit_testBonus_2(self): 
		self.doCase(testBonus, self.testBonus_caseGen)
	def test_extra_credit_testBonus_3(self): 
		self.doCase(testBonus, self.testBonus_caseGen)
	...
	def test_extra_credit_testBonus_5(self): 
		self.doCase(testBonus, self.testBonus_caseGen)
	def test_extra_credit_testBonus_6(self): 
		self.doCase(testBonus, self.testBonus_caseGen)
	def test_extra_credit_testBonus_7(self): 
		self.doCase(testBonus, self.testBonus_caseGen)
	def test_extra_credit_testBonus_8(self): 
		self.doCase(testBonus, self.testBonus_caseGen)
	def test_extra_credit_testBonus_9(self): 
		self.doCase(testBonus, self.testBonus_caseGen)	
	############################################################################
...
class TheHardcodingTestSuite(unittest.TestSuite):
	def __init__(self,wants):
		self.num_req = 0
		self.num_ec = 0
		# find all methods that begin with "test".
		fs = []
		for w in wants:
			for func in HardcodeTests.__dict__:
				# append regular tests
				# drop any digits from the end of str(func).
				dropnum = str(func)
				while dropnum[-1] in "1234567890":
				...
				if dropnum==("test_"+w+"_") or (dropnum==("test_extra_credit_"+w+"_")):
					fs.append(HardcodeTests(str(func)))
